...
func TestParseSource(t *testing.T) {
	cases := []struct {
		...
		{in: "https://github.com/o/r/tree/main/plugins/pii", repo: "https://github.com/o/r.git", sub: "plugins/pii", ref: "main", name: "pii"},
		{in: "https://github.example.com/o/r/tree/v1.2.0/plugins/pii/", repo: "https://github.example.com/o/r.git", sub: "plugins/pii", ref: "v1.2.0", name: "pii"},
		{in: "gitlab.example.com/team/repo/p", repo: "https://gitlab.example.com/team/repo.git", sub: "p", name: "p"},
		{in: "https://gitlab.example.com/group/subgroup/repo/-/tree/main/plugins/pii", repo: "https://gitlab.example.com/group/subgroup/repo.git", sub: "plugins/pii", ref: "main", name: "pii"},
		...
		{in: "http://github.com/o/r/tree/main/plugins/pii", wantErr: true},
		{in: "https://github.com/o/r/blob/main/plugins/pii", wantErr: true},
		{in: "https://github.com/o/r/tree/main", wantErr: true},
		{in: "https://github.com/o/r/tree/main/plugins/pii?plain=1#readme", repo: "https://github.com/o/r.git", sub: "plugins/pii", ref: "main", name: "pii"},
		{in: "https://gitlab.example.com/group/repo/-/tree/main/plugins/pii?ref_type=heads", repo: "https://gitlab.example.com/group/repo.git", sub: "plugins/pii", ref: "main", name: "pii"},
		{in: "https://github.com/o/r/tree/main/plugins%2Fpii", wantErr: true},
		{in: "https://gitlab.example.com/group/repo/-/tree/main", wantErr: true},
