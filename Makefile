...
TESTDATA_DIRS := examples/plugins/test-invalid-scheduling examples/plugins/test-tool-role-message examples/plugins/test-redacted-thinking examples/plugins/test-envelope-smuggler examples/plugins/test-extension-contract examples/plugins/test-stream-mutator examples/plugins/test-stream-mutator-nogrant examples/plugins/test-stream-fanout examples/plugins/test-stream-fanout-boundaries examples/plugins/test-stream-reindex-nogrant examples/plugins/test-stream-complete-block-nogrant examples/plugins/test-stream-complete-block-granted examples/plugins/test-stream-complete-signed-tool examples/plugins/test-stream-delay-stop examples/plugins/test-stream-early-stop examples/plugins/test-blocker examples/plugins/test-blocker-nogrant examples/plugins/test-toolresult-helper examples/plugins/test-toolresult-helper-nogrant examples/plugins/test-observer examples/plugins/test-responder examples/plugins/test-responder-nogrant examples/plugins/test-original examples/plugins/test-router examples/plugins/test-ticker examples/plugins/test-http-server examples/plugins/test-metrics examples/plugins/test-mutator examples/plugins/test-hostcall examples/plugins/test-fragment-buffer examples/plugins/test-inert-a examples/plugins/test-inert-b examples/plugins/test-inert-c examples/plugins/test-trapper examples/plugins/test-block-then-trap examples/plugins/test-invalid-replacement examples/plugins/test-forge-response-fields examples/plugins/test-invented-content examples/plugins/test-forge-host-meta examples/plugins/test-stale-bind examples/plugins/test-verdict-then-invalid examples/plugins/test-records-invocation examples/plugins/test-trapper-response examples/plugins/test-trapper-stream examples/plugins/test-tool-rewriter examples/plugins/test-malformed-result examples/plugins/test-trapper-after-stream examples/plugins/test-slow-after-stream examples/plugins/test-header-observer examples/plugins/test-header-observer-b examples/plugins/test-header-observer-nogrant examples/plugins/test-http-server-nogrant
