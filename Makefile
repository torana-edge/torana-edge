...
PLUGIN_DIRS := plugins/cache_tier_selector plugins/schema_translator plugins/intent plugins/keyword_compactor plugins/compactor plugins/otel plugins/auth plugins/pii
TESTDATA_DIRS := examples/plugins/test-stream-mutator examples/plugins/test-blocker examples/plugins/test-blocker-nogrant examples/plugins/test-observer examples/plugins/test-responder examples/plugins/test-responder-nogrant examples/plugins/test-original examples/plugins/test-router examples/plugins/test-ticker
